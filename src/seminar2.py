...
class SoftmaxClassifier:
    ...
    def train(self, X, y, learning_rate=1e-3, reg=1e-1, num_iters=10000,
        ...
        for it in range(num_iters):
            ...
            batch_indices = np.random.choice(np.arange(X.shape[0]), size=batch_size, replace=True)
